...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 text-white px-4 lg:px-8 py-3 shadow-xl">
      <div className="max-w-7xl mx-auto flex flex-col gap-2">
        {/* Main Row: Left Title Stack & Right Action Buttons */}
        <div className="flex flex-col md:flex-row items-start justify-between gap-4">
          ...
          {/* Right Column: Action Buttons Grouped & Right-Justified */}
